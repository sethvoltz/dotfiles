...
cli_apps=(coreutils spark git mercurial wtf ack grc htop-osx iftop mtr nmap p0f trafshow wtf ngrep wget tree ctags graphviz)
cli_exec=(gsort     spark git hg        wtf ack grc htop     iftop mtr nmap p0f trafshow wtf ngrep wget tree ctags dot     )
