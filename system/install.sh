...
cli_apps=(coreutils spark wtf ack grc htop iftop mtr nmap p0f trafshow ngrep wget tree ctags graphviz jq)
cli_exec=(gsort     spark wtf ack grc htop iftop mtr nmap p0f trafshow ngrep wget tree ctags dot      jq)
