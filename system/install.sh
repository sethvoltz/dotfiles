...
cli_apps=(coreutils spark git wtf ack grc htop iftop mtr nmap p0f trafshow wtf ngrep wget tree ctags graphviz jq brightness switchaudio-osx)
cli_exec=(gsort     spark git wtf ack grc htop iftop mtr nmap p0f trafshow wtf ngrep wget tree ctags dot      jq brightness SwitchAudioSource)
