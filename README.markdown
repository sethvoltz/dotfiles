...
This dotfiles organization system is heavily based on @holman's dotfiles
repository. [Rad his post on the
...
[check out the original project](https://github.com/holman/dotfiles/) on his
repository.
